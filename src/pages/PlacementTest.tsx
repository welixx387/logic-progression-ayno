...
const WHAT: Record<CategoryId, string> = {
  ...
  memory: 'Тест проверит, сколько чисел, слов, пар и деталей вы удерживаете в памяти, — и откроет подходящие уровни в темах памяти. Материал показывается на время, потом скрывается.',
  academic: '',
}
