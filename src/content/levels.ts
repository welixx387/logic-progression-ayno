...
export const LEVELS: LevelInfo[] = [
  {
    ...
    description: 'Закономерности в один шаг. Подходит для первого знакомства с логическими задачами.',
    xp: 10,
    text: 'text-lvl1',
    bg: 'bg-lvl1',
  },
  ...
  },
  {
    ...
    name: 'Продвинутый',
    tag: 'для сильных',
    description: 'Многошаговые выводы, скрытые закономерности и аккуратный перебор вариантов.',
    xp: 40,
    text: 'text-lvl4',
    bg: 'bg-lvl4',
  },
  {
    ...
    description: 'Минимум подсказок — максимум логики. Задачи уровня олимпиад и сложных тестов.',
    xp: 60,
    text: 'text-lvl5',
    bg: 'bg-lvl5',
  },
